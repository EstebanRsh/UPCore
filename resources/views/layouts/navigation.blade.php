                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link href="#" class="text-gray-400 cursor-not-allowed">Aprobaciones
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out {{ request()->routeIs('planes.*') ? 'border-indigo-400 text-gray-900 focus:outline-none focus:border-indigo-700' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('planes.index')">Planes de Internet</x-dropdown-link>
                                <x-dropdown-link href="#" class="text-gray-400 cursor-not-allowed">Zonas de
                                    Cobertura (Próximamente)</x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
